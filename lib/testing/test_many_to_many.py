...
def test_contract_contracts_by_date():
  ...
  # Clear the members list before running the test
  Contract.all = []
  ...
  # Assert that the contracts_by_date method returns the correct contracts
  assert set(Contract.contracts_by_date('01/01/2001')) == set([contract2, contract4])